...
namespace Sample.Sdk.Core.Azure.ActiveDirectoryLibs.AppRegistration
{
    /// <summary>
    ...
    /// </summary>
    public class ApplicationRegistrationProvider : IApplicationRegistration
    {
                                            ...
                                            CancellationToken cancellationToken)
        {
            ...
            foreach (var application in applications.Value)
            {
                ...
                {
                    e.LogException(_logger.LogCritical);
                    throw new InvalidOperationException("Application delete fail");
                }
            }
            return true;
        }
        ...
        /// <param name="prefix"></param>
        /// <returns></returns>
        public async Task<(bool isValid, Enums.Setup reason)>
            ...
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    return (false, Setup.ApplicationOrServicePrincipleNotFound);//runtime stop the service and recreate the
                }
                try
                {
                ...
                {
                    e.LogException(_logger.LogCritical);
                    return (false, Setup.ApplicationOrServicePrincipleNotFound);
                }
                ...
                {
                    return (false, Setup.ApplicationIdSecretNotFoundOnKeyVault);
                }
                var tenantId = _clientSecretCredFactory.GetDefaultTenantId();
