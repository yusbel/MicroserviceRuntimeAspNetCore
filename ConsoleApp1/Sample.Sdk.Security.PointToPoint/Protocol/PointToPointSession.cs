...
using System.Text;
using static Sample.Sdk.Interface.Enums.Enums;
    ...
    public class PointToPointSession : PointToPointSessionRoot, IPointToPointSession
    {
            ...
            , CancellationToken token)
        {
            ...
            (bool wasCreated, byte[]? data, EncryptionDecryptionFail reason) signature =
                await cryptoProvider.CreateSignature(Encoding.UTF8.GetBytes(baseSignature), Enums.HostTypeOptions.ServiceInstance, token);
